...
typedef enum { ResolveTokenError_OutOfRange, ResolveTokenError_BadTable, ResolveTokenError_Other } MonoResolveTokenError;

MONO_API MONO_RT_EXTERNAL_ONLY int mono_reflection_parse_type(char *name, MonoTypeNameParse *info);
MONO_API MONO_RT_EXTERNAL_ONLY MonoType *mono_reflection_get_type(MonoImage *image, MonoTypeNameParse *info, mono_bool ignorecase,
                                                                  mono_bool *type_resolve);
...
MONO_API MONO_RT_EXTERNAL_ONLY uint32_t mono_reflection_get_token(MonoObject *obj);
...
MONO_API MONO_RT_EXTERNAL_ONLY MonoReflectionModule *mono_module_file_get_object(MonoDomain *domain, MonoImage *image,
                                                                                 int table_index);
MONO_API MONO_RT_EXTERNAL_ONLY MonoReflectionType *mono_type_get_object(MonoDomain *domain, MonoType *type);
MONO_API MONO_RT_EXTERNAL_ONLY MonoReflectionMethod *mono_method_get_object(MonoDomain *domain, MonoMethod *method,
                                                                            MonoClass *refclass);
MONO_API MONO_RT_EXTERNAL_ONLY MonoReflectionField *mono_field_get_object(MonoDomain *domain, MonoClass *klass,
                                                                          MonoClassField *field);
MONO_API MONO_RT_EXTERNAL_ONLY MonoReflectionProperty *mono_property_get_object(MonoDomain *domain, MonoClass *klass,
...
MONO_API MONO_RT_EXTERNAL_ONLY MonoArray *mono_reflection_get_custom_attrs_blob(MonoReflectionAssembly *assembly,
                                                                                MonoObject *ctor, MonoArray *ctorArgs,
                                                                                MonoArray *properties, MonoArray *porpValues,
                                                                                MonoArray *fields, MonoArray *fieldValues);
...
MONO_API MonoBoolean mono_declsec_get_linkdemands(MonoMethod *callee, MonoDeclSecurityActions *klass,
